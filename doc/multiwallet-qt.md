...
In order to support loading of multiple wallets in vul-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vul.cpp.
...
Changes to vul.cpp
----------------------
vul.cpp is the entry point into vul-qt, and as such, will require some minor modifications to provide hooks for
