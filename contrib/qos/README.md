...
This means one can have an always-on vuld instance running, and another local vuld/vul-qt instance which connects to this node and receives blocks from it.
