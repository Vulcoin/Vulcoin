...
RESOURCES += src/qt/vul.qrc src/qt/vul_locale.qrc

TRANSLATIONS += src/qt/locale/vul_bg.ts \
                src/qt/locale/vul_de.ts \
                src/qt/locale/vul_en.ts \
                src/qt/locale/vul_es.ts \
                src/qt/locale/vul_fi.ts \
                src/qt/locale/vul_fr.ts \
                src/qt/locale/vul_it.ts \
                src/qt/locale/vul_ja.ts \
                src/qt/locale/vul_pl.ts \
                src/qt/locale/vul_pt.ts \
                src/qt/locale/vul_ru.ts \
                src/qt/locale/vul_sk.ts \
                src/qt/locale/vul_sv.ts \
                src/qt/locale/vul_vi.ts \
                src/qt/locale/vul_zh_CN.ts \
                src/qt/locale/vul_zh_TW.ts
