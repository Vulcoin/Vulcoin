...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vul features */
        {"vul", "masternode", &masternode, true, true, false},
        {"vul", "listmasternodes", &listmasternodes, true, true, false},
        {"vul", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vul", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vul", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vul", "masternodedebug", &masternodedebug, true, true, false},
        {"vul", "startmasternode", &startmasternode, true, true, false},
        {"vul", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vul", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vul", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vul", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vul", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vul", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vul", "mnbudget", &mnbudget, true, true, false},
        {"vul", "preparebudget", &preparebudget, true, true, false},
        {"vul", "submitbudget", &submitbudget, true, true, false},
        {"vul", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vul", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vul", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vul", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vul", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vul", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vul", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vul", "checkbudgets", &checkbudgets, true, true, false},
        {"vul", "mnsync", &mnsync, true, true, false},
        {"vul", "spork", &spork, true, true, false},
        {"vul", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vul", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vuld, or the -server option to vul-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vul-cli " + methodname + " " + args + "\n";
}
