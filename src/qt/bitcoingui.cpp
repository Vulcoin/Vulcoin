...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VUL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vul: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vul"), this);
    aboutAction->setStatusTip(tr("Show information about Vul"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VUL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VUL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VUL addresses"));
    ...
    openAction->setStatusTip(tr("Open a VUL: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vul help message to get a list with possible VUL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vul client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VUL network", "", count));
}
...
{
    QString strTitle = tr("Vul"); // default title
