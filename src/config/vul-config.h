/* src/config/vul-config.h.  Generated from vul-config.h.in by configure.  */
/* src/config/vul-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.vul.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vul Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vul Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vul"
