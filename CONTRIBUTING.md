...
The Vul project operates an open contributor model where anyone is
...
The following applies to code changes to the Vul project, and is not to be
confused with overall VUL Network Protocol consensus changes.

Whether a pull request is merged into Vul rests with the project merge
...
Patches that change VUL consensus rules are considerably more involved than
...
Where a patch set proposes to change the VUL consensus, it must have been
...
The project leader is the release manager for each Vul release.
